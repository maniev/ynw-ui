        ...
        fp.submit = function (email) {
            ...
            urlService.post(fpUrl, null).then(function (response) {
                ...
                fp.otpVerify = function () {
                    $scope.success=false;
                    $scope.danger=false;
                    urlService.post(urlConstants.CONSUMERRESETURL + fp.otpInfo.activationId + '/validate').then(function (response) {
                        ...
                        fp.completeFP = function () {                        
                            urlService.put(urlConstants.CONSUMERRESETURL+fp.otpInfo.activationId, fp.credentialInfoC).then(function (response) {
                                  $scope.success=true;
                                  $scope.danger=false;
