...
define(['../consumerModule'], function (consumerModule) {
    return consumerModule.controller('ConsumerWLViewCtrl',['$scope','UrlService','UrlConstants','$log','ModalService','$stateParams', 
    	function ($scope,urlService,urlConstants,$log,modalService, $stateParams) {
        var src=this;
        src.serv={};
        
        var searchText=$stateParams.searchText;
        searchText="9605551784";
        //urlService.get(urlConstants.ACCOUNTURL+"/"+searchText+"/search").then(function (response) {
           ...
           var bpurl="http://ynw.youneverwait.com/"+searchText+"/businessProfile.json";
           var serviceurl="http://ynw.youneverwait.com/"+searchText+"/services.json";
